...
const MainService = ({}: Props) => {
  const serviceItems = [
    {
      cont: '1ページ単位からのコーディング、WordPressの構築のみもお受けいたします。また、W3Cに準拠したコーディング、保守運用がしやすい構築を行い、管理しやすいWebサイトを制作いたします。',
      src: '/img/web.svg',
      tit: 'LP・HP制作'
    },
    {
      cont: '「EC-CUBE」というプラットフォームを利用したECサイトの構築を行います。お客様のご希望に合ったテーマの選定とカスタマイズなど、柔軟にご対応いたします。',
      src: '/img/ec.svg',
      tit: 'ECサイト制作'
    },
    {
      cont: '「kintone」というノーコードツールを利用したアプリ開発を行います。「JavaScript」を利用して、お客様のご希望に合った、オリジナルアプリを作成することも可能です。',
      src: '/img/kintone.svg',
      tit: 'kintoneアプリ開発'
    }
  ];
